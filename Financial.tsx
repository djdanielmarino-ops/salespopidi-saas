            ...
            <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
              ...
              <Card>
                ...
                <CardContent>
                  ...
                  <p className="text-xs text-muted-foreground">
                    Produtos: R$ {(financialData?.productCost || 0).toLocaleString('pt-BR', { minimumFractionDigits: 2 })} | Manuais: R$ {(financialData?.manualCost || 0).toLocaleString('pt-BR', { minimumFractionDigits: 2 })}
                  </p>
                </CardContent>
              </Card>
